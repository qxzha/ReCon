...
def parse_opt():
    ...
    # --------------------------- data path -------------------------#
    parser.add_argument('--data_name', default=f'now100k_precomp',
                        help='{coco,f30k,cc152k,now}_precomp')
    parser.add_argument('--data_path', default='/data',
                        help='path to datasets')
    parser.add_argument('--vocab_path', default='/data/vocab',
                        help='Path to saved vocabulary json files.')
    parser.add_argument('--folder_name', default='./relation', help='Folder name to save the running results')
    parser.add_argument(
        "--tokenizer", default="bert", help="{bpe,bert}"
    )

    # ----------------------- training setting ----------------------#
    parser.add_argument('--batch_size', default=128, type=int,
                        help='Size of a training mini-batch.')
    parser.add_argument('--schedules', default='5, 5, 5, 30', type=str, help='Folder name to save the running results')
    ...
    # parser.add_argument('--alpha', action= 'store_false')
    parser.add_argument('--warm_epoch', default=5, type=int)
    parser.add_argument('--omega1', default=0.5, type=float)
    parser.add_argument('--omega2', default=0.5, type=float)
    parser.add_argument('--eta', default=5, type=int)
    parser.add_argument('--xi', default=5, type=int)
