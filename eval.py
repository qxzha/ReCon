...
if __name__ == '__main__':
    ...
    model_paths = [
        './runs/expand/f30k_SAF_0.7/checkpoint_dir/model_best.pth.tar',
        './runs/expand/f30k_SGR_0.7/checkpoint_dir/model_best.pth.tar']
    ...
    if module_name == 'VSEinfty':
        ...
        if avg_SGRAF and len(model_paths) == 2:
            ...
            vocab_path = opt0.vocab_path
            # vocab_path = "/home/quaner/datasets/NCR-data"
